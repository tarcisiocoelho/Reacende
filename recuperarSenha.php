...
<head>
    ...
    <link rel="stylesheet" href="./css/receuperarSenha.css">
    <script src="./js/cadastroEmpresa.js"></script>
    <title>Reacende-Recuperar Senha</title>
</head>
...
<body>
    ...
    <main>
        <div class="caixaDeTexto">
            ...
            <form>
                <input class="input-texto email" type="text" name="email" id="email" placeholder="Digite seu e-mail">
                <p> Voce irá receber uma senha temporária no seu email cadastrado<br> (atenção a senha temporaria tem validade de apenas duas horas)</p>
                <button type="submit" id="enviarCadEmpresa">Enviar</button>
            </form>
        </div>
        <div class='logoMain'>
            <img src="./imagens/lampada.png" alt="Reascende" height="300px">
        </div>
