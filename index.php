...
<body>
    ...
    <div class="menu">
        ...
        <div class="menuBotao">
            <a href="login.php"><button id="mentrar" onclick="clicmenu()">Entrar</button></a>
            <a href="cadastrar.php"><button id="mcadastrar" onclick="clicmenu()">Cadastre-se</button></a> 
        </div>
    </header>
    <main>
        <div>
        ...
        <div class="souMais">
            <img src="./imagens/jovens-idosos-felicidade.jpg" alt="">
            <div class="textoSouMais">
                
                <p class="titulo">O CONHECIMENTO QUE REACENDE SUA VIDA PROFISSIONAL</p>
                <ul class="lista">
                    <li>Básico em Internet/Computador</li><br>
                    <li>Pacote Office</li><br>
                    <li>Soft Skills</li><br>
                    <li>Hard Skills</li><br>
                    <li>Outlook, Gmail</li><br>
