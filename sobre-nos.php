...
<body>
    <header>
        <div class="menu">
            ...
            <a href="index.php"><p>REACENDE</p></a>
            <a href="sobre-nos.php"><p>SOBRE NÓS</p></a>
            <a href="sou-mais-50.php"><p>SOU +50</p></a>
            <a href="sou-empresa.php"><p>SOU EMPRESA</p></a>
            <a href="nossos-cursos.php"><p>NOSSOS CURSOS</p></a>
        </div>
        <div class="menuBotao">
    ...
    <main>
        ...
        <div class="infoSobreNos">
            <div class="textoInfoSobreNos">
                <h2>PROJETO REACENDE</h2><br>
                <p>Somos um projeto dedicado para a reinserção de pessoas acima dos 50 anos ao mercado de trabalho. Muitos não tiveram a oportunidade de se capacitar e se preparar para todas as mudanças em que vivemos hoje, por isso, visamos exclusivamente o público da classe 50+. Queremos capacitar, desenvolver e incluir essa geração novamente ao mercado oferecendo empregos dignos. Se você mora em São Paulo com renda per capita de até 1 salário mínimo e com ensino médio completo, venha fazer parte dessa transformação.</p>
            </div>
            <img src="./imagens/idoso-no-pc.jpg" alt="">
        </div>
